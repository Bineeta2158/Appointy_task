...
func homePage(w http.ResponseWriter, r *http.Request){
    ...
    fmt.Fprintln(w, "To list all articles : http://localhost:10000/articles")
fmt.Fprintln(w, "To create new article : http://localhost:10000/create")
fmt.Fprintln(w, "To find article by id : http://localhost:10000/article?id=<id_here>")
fmt.Fprintln(w, "To search article : http://localhost:10000/article/search?q=<query_here>")
...
func createNewArticle(w http.ResponseWriter, r *http.Request) {
  ...
  if err != nil {
      ...
      fmt.Fprintln(w, "New Article added in the memory, List all artcles to verify! New Article that is added:")
      json.NewEncoder(w).Encode(article)
